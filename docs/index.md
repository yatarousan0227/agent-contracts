...
Welcome to the documentation for **Agent Contracts**, a type-safe, modular, and observable framework for building AI agents.
...
- **[API Reference](api_reference.md)**: Public APIs and usage details.
...
- **[API Reference](api_reference.ja.md)**: 公開APIと使い方の概要。
